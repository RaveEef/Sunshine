...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        assertTrue("Error: This means that the database had not been created correctly", c.moveToFirst());
        ...
        c = db.rawQuery("PRAGMA table_info(" + WeatherContract.LocationEntry.TABLE_NAME + ")",
               null);
        assertTrue("This means that we were unable to query the database for table information",
                c.moveToFirst());
    ...
    public void testLocationTable(){
        ...
        Cursor cursor = db.query(
                ...
                null,   //No columns to group by
                null,   //No columns to filter by row groups
                null);  //No sort order
    ...
    public void testWeatherTable() {
        ...
        Cursor weatherCursor = db.query(
                ...
                null,   //No values for "where" clause
                null,   //No columns to group by
                null,   //No columns to filter by row group
                null);  //No order to sort by

        assertTrue("Error: No Records returned by weather query", weatherCursor.moveToFirst());
